package com.teammeditalk.medicationproject.ui.edit
...
class EditAllergyActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            MedicationProjectTheme {
                AllergyContent(
                    context = this@EditAllergyActivity,
    ...
    fun AllergyContent(
        ...
        Column(
                ...
                items(allergyItems) {
                    OutlinedButton(
                        ...
                        colors = ButtonDefaults.outlinedButtonColors(
                            containerColor = if (it in selectedAllergies){
            ...
            Button(
                onClick = {
                    Log.d("알레르기",selectedAllergies.toString())
                }) {
                Text(
                    modifier = modifier
                        .padding(8.dp)
